  ...
  <header>
    ...
    <main>
      <article class="places">
       ...
       <div class="places1"><h3> Enoggera</h3></div>
       
       <div class="parallax"></div>
       <div class="places2"><h3>Pinkenba</h3></div>

       <div class="parallax"></div>
       <div class="places3"><h3>Melbourne</h3></div>

       <div class="parallax"></div>
       <div class="places4"><h3>Albany</h3></div>

       <div class="parallax"></div>
       <div class="places5"><h3>Colombo(Sri-Lanka)</h3></div>

       <div class="parallax"></div>
       <div class="places6"><h3>Aden</h3></div>

       <div class="parallax"></div>
       <div class="places7"><h3>Egypt</h3></div>

       <div class="parallax"></div>
       <div class="places8"><h3>Suez</h3></div>

       <div class="parallax"></div>
       <div class="places9"><h3>Port Said</h3></div>

       <div class="parallax"></div>
       <div class="places10"><h3>Alexandria</h3></div>

       <div class="parallax"></div>
       <div class="places11"><h3>Cairo</h3></div>

       <div class="parallax"></div>
       <div class="places12"><h3>Mena Camp</h3></div>

       <div class="parallax"></div>
       <div class="places13"><h3>Kasî-el-Nil Barracks</h3></div>

       <div class="parallax"></div>
       <div class="places14"><h3>Lemnos Is.</h3></div>

       <div class="parallax"></div>
       <div class="places15"><h3>Dardenelles</h3></div>

       <div class="parallax"></div>
       <div class="places16"><h3>Gallipoli</h3></div>

       <div class="parallax"></div>
       <div class="places17"><h3>Malta</h3></div>

       <div class="parallax"></div>
       <div class="places18"><h3>Fort Tigne</h3></div>

       <div class="parallax"></div>
       <div class="places19"><h3>Slienna</h3></div>
